...
1. Go to [OpenRouter Settings → Observability](https://openrouter.ai/settings/integrations)
2. Enable **Broadcast**
...
6. Click **Send Trace** to send a test trace
7. Click **Add** to save

### 3. Verify in Traceway

Open your Traceway dashboard and navigate to **AI Traces**. You should see your test trace appear within a few seconds.
