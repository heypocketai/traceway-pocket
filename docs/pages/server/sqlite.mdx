...
**3. Add a volume at `/data`.** Open **Settings → Volumes**, add a new volume, and set the mount path to `/data`. Without this, your SQLite files and uploaded blobs get wiped on every redeploy.
