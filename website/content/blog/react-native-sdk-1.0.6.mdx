...
- **No screen recording.** Unlike the browser SDK, this package does not record the screen. The `rrweb` recorder is intentionally absent — nothing in the bundle reaches into a DOM that doesn't exist.
